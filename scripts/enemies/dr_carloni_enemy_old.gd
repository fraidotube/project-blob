...
@export var throw_release_time: float = 0.72
...
const ANIM_RECALL_ENTER: StringName = &"Spell_Simple_Enter"
const ANIM_RECALL_EXIT: StringName = &"Spell_Simple_Exit"
...
func _start_recall() -> void:
	...
	_stop_horizontal_motion()
	_face_player()
	_play_standard(ANIM_RECALL_ENTER)
...
func _on_hammer_reached_hand() -> void:
	...
	_play_standard(ANIM_RECALL_EXIT)
...
func _stop_other_players(except: AnimationPlayer) -> void:
	for p in [standard_player, ual2_player, human_idle_player]:
